...
public class Algoritmo33Test {
    ...
    public void testSegundoParametroInvalido() throws Exception {
        int []a = {2, 3, 5, 6, 7, 8, 4, 2, 5, 6, 7, 2, 1};
        Algoritmo33.Cpf(a);
    }

    @Test
    public void testCasoTrivial() {
        int[] d = {0, 5, 0, 8, 8, 3, 1, 2, 5, 3, 9};
        Assert.assertFalse(Algoritmo33.Cpf(d));
        int[] a = {0, 1, 2, 1, 2, 4, 5, 0, 1, 2, 4};
        Assert.assertFalse(Algoritmo33.Cpf(a));
